...
func TestInstallAndUninstallDBDrivers(t *testing.T) {
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/postgres@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/postgres@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/mysql@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/mysql@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/sqlserver@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/sqlserver@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/sqlite@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/sqlite@v1.17.x"))
...
func TestInstallAndUninstallFilesystemDrivers(t *testing.T) {
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/s3@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/s3@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/cos@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/cos@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/oss@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/oss@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/minio@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/minio@v1.17.x"))
...
func TestInstallAndUninstallCacheDrivers(t *testing.T) {
	assert.NoError(t, facades.Artisan().Call("package:uninstall github.com/goravel/redis@v1.17.x"))
	...
	assert.NoError(t, facades.Artisan().Call("package:install github.com/goravel/redis@v1.17.x"))
