...
require (
	...
	github.com/charmbracelet/huh/spinner v0.0.0-20250320172351-ff9123a4929b // indirect
...
replace (
	github.com/goravel/fiber => ../goravel/fiber
	github.com/goravel/framework => ../goravel/framework
	github.com/goravel/gin => ../goravel/gin
	github.com/goravel/redis => ../goravel/redis
	github.com/goravel/sqlite => ../goravel/sqlite
)
