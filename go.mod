...
require (
	...
	github.com/goravel/framework v1.16.1-0.20251231025904-e7fa6ed025dc
	...
	github.com/goravel/redis v1.4.1-0.20251027061218-1700878059b1
...
replace github.com/goravel/gin => ../goravel/gin
